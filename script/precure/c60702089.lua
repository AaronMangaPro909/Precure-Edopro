...
function s.initial_effect(c)
     ...
     local CARD_CURE_IDOL = 39517404
     local SET_PRECURE = 0xb54

	c:EnableReviveLimit()
	--fusion material
	Fusion.AddProcMixRep(c,true,true,aux.FilterBoolFunctionEx(Card.IsSetCard,(SET_PRECURE)),1,99,CARD_CURE_IDOL)
	--spsummon condition
...
s.material_setcode={SET_PRECURE,CARD_CURE_IDOL}
